...
const Sidebar = () => {
  ...
  return (
    <div className="absolute  z-10 shadow-2xl">
      <aside className=" w-64 bg-gray-800 md:block min-h-screen">
        <div className="py-3 text-2xl uppercase ps-5 tracking-widest bg-gray-900 border-b-2 border-gray-800 mb-8">
